...
streznik.post('/prijava', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    if(napaka2)message = "Prišlo je do napake pri registraciji nove stranke. Prosim preverite vnešene podatke in" +
        " poskusite znova";
    else message = "Stranka je bila uspešno registrirana";
    odgovor.redirect("#");
    odgovor.end();
  });
});
